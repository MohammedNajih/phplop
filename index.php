...
$id = $_GET['id'];
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, 'https://www.idcardcentre.co.uk/index.php?route=extension/payment/stripe/createPaymentIntent');
...
curl_setopt($ch, CURLOPT_POSTFIELDS, 'payment_method='.$id.'&store_card=false');
$fim = curl_exec($ch);
echo $fim;
